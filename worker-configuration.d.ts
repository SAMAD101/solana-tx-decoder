/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 91bdf6a6fdffbefa0bf5bba37cb21432)
// Runtime types generated with workerd@1.20260921.1 2026-09-21 nodejs_compat
interface __BaseEnv_Env {
  AI: Ai;
  SOLANA_RPC_URL: string;
  TxExplainerAgent: DurableObjectNamespace<
    import("./src/server").TxExplainerAgent
  >;
  EXPLAIN_TX: Workflow<
    Parameters<import("./src/server").ExplainTxWorkflow["run"]>[0]["payload"]
  >;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/server");
    durableNamespaces: "TxExplainerAgent";
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "SOLANA_RPC_URL">
  > {}
}
